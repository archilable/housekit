  ...
  return (
    <div style={{ padding: '20px 16px' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <h1 style={{ fontSize: 20, fontWeight: 500, marginTop: 12 }}>설비 수정</h1>
      </div>

      <form action={updateInventory.bind(null, itemId)} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          <div>
            ...
            <input name="installedAt" type="date" defaultValue={installedAtValue} style={inputStyle} />
          </div>
          <div>
        ...
        <div>
          ...
          <textarea name="notes" rows={2} defaultValue={item.notes ?? ''} style={{ ...inputStyle, resize: 'none' as const }} />
        </div>
