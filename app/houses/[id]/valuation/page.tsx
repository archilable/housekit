  ...
  return (
    <div style={{ padding: '20px 16px', maxWidth: '100%' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <h1 style={{ fontSize: 21, fontWeight: 500, marginTop: 14, marginBottom: 4 }}>시세 정보 입력</h1>
        <p style={{ fontSize: 14, color: '#666' }}>{house.address}</p>
      </div>
      ...
      <form action={upsertValuation} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        {isApt ? (
          ...
          <div style={{ background: '#0d1a2e', border: '0.5px solid #1e3a5f', borderRadius: 16, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
              <i className="ti ti-building-skyscraper" style={{ fontSize: 21, color: '#60a5fa' }} />
              <span style={{ fontSize: 16, fontWeight: 500, color: '#60a5fa' }}>공동주택 공시가격</span>
            </div>
            <div style={fieldStyle}>
              <label style={labelStyle}>공동주택 공시가격 (원) <span style={{ color: '#555', fontSize: 12 }}>— 국토부 공시</span></label>
            ...
            <div style={{ ...fieldStyle, marginTop: 12 }}>
              <label style={labelStyle}>공시가격 반영률 <span style={{ color: '#555', fontSize: 12 }}>— 보통 0.69~0.75</span></label>
          ...
          <>
            <div style={{ background: '#0d1a2e', border: '0.5px solid #1e3a5f', borderRadius: 16, padding: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
                <i className="ti ti-map-pin" style={{ fontSize: 21, color: '#fbbf24' }} />
                <span style={{ fontSize: 16, fontWeight: 500, color: '#fbbf24' }}>토지가</span>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <div style={fieldStyle}>
                  <label style={labelStyle}>개별공시지가 (원/㎡) <span style={{ color: '#555', fontSize: 12 }}>— 국토부 부동산공시가격알리미</span></label>
                ...
                <div style={fieldStyle}>
                  <label style={labelStyle}>지분율 <span style={{ color: '#555', fontSize: 12 }}>— 단독=1.0 / 공동소유시 본인 지분</span></label>
            ...
            <div style={{ background: '#111118', border: '0.5px solid #1e1e28', borderRadius: 16, padding: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
                <i className="ti ti-home-2" style={{ fontSize: 21, color: '#a78bfa' }} />
                <span style={{ fontSize: 16, fontWeight: 500, color: '#a78bfa' }}>건물가</span>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <div style={fieldStyle}>
                  <label style={labelStyle}>건축비 단가 (원/㎡) <span style={{ color: '#555', fontSize: 12 }}>— 표준 단가 약 80~150만원</span></label>
                ...
                <div style={fieldStyle}>
                  <label style={labelStyle}>연 감가율 <span style={{ color: '#555', fontSize: 12 }}>— 일반적으로 0.02 (2%) / 건물 경과 {age}년</span></label>
        ...
        {/* 안내 */}
        <div style={{ background: '#111118', borderRadius: 12, padding: 14, fontSize: 13, color: '#555', lineHeight: 1.7 }}>
          <p>💡 공시지가는 <span style={{ color: '#60a5fa' }}>국토부 부동산공시가격알리미</span>에서 확인하세요.</p>
          <p style={{ marginTop: 4 }}>💡 계산된 금액은 참고용 추정치로 실제 시세와 다를 수 있습니다.</p>
        </div>

        <button type="submit" style={{ background: '#1d4ed8', color: '#fff', border: 'none', borderRadius: 14, padding: '15px', fontSize: 16, fontWeight: 500, cursor: 'pointer', width: '100%' }}>
          저장 및 계산하기
        </button>
      </form>
    </div>
