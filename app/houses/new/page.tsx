  ...
  return (
    <div style={{ padding: '20px 16px', maxWidth: '100%' }}>
      <div style={{ marginBottom: 28 }}>
        <Link href="/houses" style={{ color: '#555', textDecoration: 'none', fontSize: 14 }}>
          <i className="ti ti-arrow-left" style={{ fontSize: 21, verticalAlign: -3 }} aria-hidden="true" />
        </Link>
        <h1 style={{ fontSize: 21, fontWeight: 500, marginTop: 14, marginBottom: 4 }}>주택 등록</h1>
        <p style={{ fontSize: 14, color: '#666' }}>집의 이력서를 시작하세요</p>
      </div>
