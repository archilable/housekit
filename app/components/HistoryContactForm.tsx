      ...
      <label style={{
        ...
        {image ? (
          <>
            ...
            <div>
              <p style={{ fontSize: 12, color, fontWeight: 500 }}>✓ {label} 첨부됨</p>
              <p style={{ fontSize: 11, color: '#555', marginTop: 2 }}>탭해서 다시 첨부</p>
            </div>
          </>
        ) : (
          <>
            ...
            <div>
              <p style={{ fontSize: 13, color: '#888' }}>{loading ? '처리 중...' : `${label} 촬영 / 업로드`}</p>
              <p style={{ fontSize: 11, color: '#444', marginTop: 2 }}>사진 또는 파일 이미지</p>
            </div>
          </>
        )}
      </label>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '4px 0' }}>
        ...
        <p style={{ fontSize: 11, color: '#444', whiteSpace: 'nowrap' }}>업체 / 담당자 정보</p>
        <div style={{ flex: 1, height: 1, background: '#1e1e28' }} />
      </div>
          ...
          {contactImage ? (
            <>
              ...
              <div>
                {extracting
                  ...
                  : <p style={{ fontSize: 12, color: '#34d399', fontWeight: 500 }}>✓ 명함 인식 완료</p>
                }
            ...
            <>
              <div style={{ width: 40, height: 40, borderRadius: 10, background: '#60a5fa22', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <i className="ti ti-id-badge" style={{ fontSize: 20, color: '#60a5fa' }} />
              </div>
              <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '4px 0' }}>
        <div style={{ flex: 1, height: 1, background: '#1e1e28' }} />
        <p style={{ fontSize: 11, color: '#444', whiteSpace: 'nowrap' }}>서류 첨부</p>
        <div style={{ flex: 1, height: 1, background: '#1e1e28' }} />
      </div>
