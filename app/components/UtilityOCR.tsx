    ...
    <div style={{ marginBottom: 20 }}>
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 14, padding: '16px', fontSize: 14, fontWeight: 500,
      ...
      {memo && (
        <div style={{ marginTop: 10, background: '#0d1f14', border: '0.5px solid #1a3d28', borderRadius: 10, padding: '10px 14px', fontSize: 12, color: '#34d399' }}>
          ✅ {memo}
        </div>
      )}
      {error && (
        <p style={{ marginTop: 8, fontSize: 12, color: '#f87171', textAlign: 'center' }}>{error}</p>
      )}
    </div>
  )
}
