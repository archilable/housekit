  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '4px 0' }}>
        ...
        <p style={{ fontSize: 12, color: '#444', whiteSpace: 'nowrap' }}>설치업체 / 담당자 정보</p>
        <div style={{ flex: 1, height: 1, background: '#1e1e28' }} />
      </div>
      ...
      <div>
        ...
        <label style={{
          ...
          {image ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, width: '100%' }}>
              ...
              <div style={{ flex: 1 }}>
                {extracting ? (
                  ...
                  <p style={{ fontSize: 13, color: '#34d399' }}>✓ 명함 인식 완료</p>
                )}
            ...
            <>
              <i className="ti ti-camera" style={{ fontSize: 23, color: '#555' }} />
              <div>
