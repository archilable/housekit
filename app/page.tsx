  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: 12 }}>
        <h1 style={{
          fontSize: 43, fontWeight: 700, letterSpacing: -2,
        ...
        <p style={{
          fontSize: 14, letterSpacing: 6, color: '#1e3a5f',
      ...
      {/* 태그라인 */}
      <p style={{
        fontSize: 16, color: '#555', lineHeight: 1.8, marginBottom: 56,
        maxWidth: 260,
      }}>
      ...
      <p style={{ fontSize: 13, color: '#2a2a38', marginTop: 24 }}>
        v0.2 · made with ♥
      </p>
    </div>
  )
